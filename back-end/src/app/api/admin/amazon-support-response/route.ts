  ...
  try {
    ...
    if (file === 'request') {
      ...
      return new NextResponse(requestTxt, {
        headers: {
          ...
          'Content-Disposition': `attachment; filename="amazon-request-${orderId}.txt"`
        }
      });
    }
    ...
    if (file === 'response') {
      ...
      return new NextResponse(responseTxt, {
        headers: {
          'Content-Type': 'text/plain',
          'Content-Disposition': `attachment; filename="amazon-response-${orderId}.txt"`
        }
      });
    }
    ...
    return NextResponse.json({
      ...
      requestFile: {
        filename: `amazon-request-${orderId}.txt`,
        content: requestTxt
      },
      responseFile: {
        filename: `amazon-response-${orderId}.txt`,
        content: responseTxt
      },
