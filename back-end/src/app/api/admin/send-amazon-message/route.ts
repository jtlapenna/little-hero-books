 ...
 * GET /api/admin/send-amazon-message?orderId=111-0060602-1283417&previewUrl=...&childName=Test
 * Add ?forceHtml=true to try HTML path (confirmCustomizationDetails + Uploads API) regardless of env.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const forceHtml = searchParams.get('forceHtml')?.toLowerCase() === 'true';
