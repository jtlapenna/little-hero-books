...
> Wonderbly lets parents pick from pre-made characters. We let them create their own. Your child's actual hair style, skin tone, and color preference are the hero on every page. Our first title, *Finding Our Inner Voice*, is about a child learning to hear and listen to their own inner voice. Soon: a growing library of stories with the option to bring your child's already-created character into each new book.
