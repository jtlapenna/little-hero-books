...
1. **MANDATORY: Remove ALL em dashes (—)** - Replace with periods, commas, or parentheses. Em dashes are one of the most obvious AI tells. Do not allow any em dashes in the final output.
