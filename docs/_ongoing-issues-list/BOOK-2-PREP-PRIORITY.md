...
| **29** | [W4 PDFMonkey half-rendered pages](29-w4-pdfmonkey-final-pdf-half-rendered-pages.md) | **Active reliability blocker.** Presigned-URL hardening is in place, but the serverless final-PDF QA path proved unstable on large production PDFs. Move final-PDF QA into the renderer service before Book 2 increases W4 volume. |
