...
- **Phase 1 jsCode:** ✅ done
- **Phase 2 cover HTML:** ✅ done
- **Phase 3 poll/download/upload:** ✅ poller implemented; download/upload nodes were already configured
- **Phase 4 QA Gate:** ✅ implemented
- **Phase 5 Acceptance Tests:** ✅ implemented
