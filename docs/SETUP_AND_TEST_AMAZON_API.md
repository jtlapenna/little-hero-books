...
return [{ json: {
  ...
  amazon: {
    clientId: "YOUR_AMAZON_CLIENT_ID", // Get from Amazon Seller Central
    clientSecret: "YOUR_AMAZON_CLIENT_SECRET", // Get from Amazon Seller Central
    refreshToken: "YOUR_AMAZON_REFRESH_TOKEN", // Get from Amazon Seller Central (starts with Atzr|)
    sellerId: "A2V719MRGLK48O",
...
- Verify Refresh Token in CONFIG node is correct (starts with `Atzr|`)
