...
// Page data: [pageNum, title, bgFile, poseFile, storyText]
const pageData = {
  1: ['Twilight Walk', 'page01-twilight-walk.png', 'walking.png', 'It was a nice evening in Seattle. Alex went for a walk. A soft voice whispered, "You are very brave."'],
  2: ['Night Forest', 'page02-night-forest.png', 'walking-looking-higher.png', 'Alex followed the voice into the forest. The trees were tall and friendly.<br>"You like to explore," the voice said.'],
  3: ['Magic Doorway', 'page03-magic-doorway.png', 'looking.png', 'Alex saw a glowing doorway. "Step through," the voice said. "You are brave." Alex took a deep breath and walked in.'],
  4: ['Courage Leap', 'page04-courage-leap.png', 'floating.png', 'Through the door were so many stars! Alex floated down like a feather. "See?" the voice laughed. "You can do amazing things!"'],
  5: ['Morning Meadow', 'page05-morning-meadow.png', 'walking-looking-down.png', 'Alex landed in a sunny meadow. Alex noticed footprints and followed them. "You are strong," the voice said.'],
  6: ['Tall Forest', 'page06-tall-forest.png', 'jogging.png', 'The path went through giant trees. Alex felt small, but not scared. "You are kind," the voice said.'],
  7: ['Mountain Vista', 'page07-mountain-vista.png', 'looking.png', 'The path went up, up, up. At the top, Alex could see everywhere!<br>"Look how far you came," the voice said.'],
  8: ['Picnic Surprise', 'page08-picnic-surprise.png', 'sitting-eating.png', 'Lunch waited on a soft blanket! There was a treat just for Alex.<br>"You earned this," the voice said.'],
  9: ['Beach Discovery', 'page09-beach-discovery.png', 'crouching.png', 'The path became warm sand. "Look down there," the voice said.<br>Alex found a beautiful shell!'],
  10: ['Crystal Cave', 'page10-crystal-cave.png', 'crawling-moving-happy.png', 'Alex found a cave with sparkly crystals! They glowed with rainbow colors. "You can find beauty everywhere," the voice said.'],
  11: ['Giant Flowers', 'page11-giant-flowers.png', 'surprised-looking-up.png', 'The path went through giant flowers. The petals were SO big!<br>"You make others happy," the voice said.'],
  12: ['Enchanted Grove', 'page12-almost-there.png', 'surprised.png', 'The voice felt very close now. "You are perfect just as you are," it said.<br>Alex looked around. Where was the voice?'],
  13: ['Animal Reveal', 'page13-animal-reveal.png', 'tiger-appears.png', 'Tiger appeared! It was the voice!<br>"I have been with you this whole time," said Tiger.'],
  14: ['Flying Home', 'page14-flying-home.png', 'flying.png', '"Ready to fly home?" asked Tiger. They flew through the stars to Seattle.<br>"I am always in your heart," said Tiger.']
};

const template = (pageNum, title, bgFile, poseFile, text) => {
...
<head>
    ...
    <title>Page ${pageStr} - ${title}</title>
    <style>
        @page {
            size: 8.5in 8.5in;
            margin: 0;
    ...
    body {
        ...
        .page {
            ...
            height: 8.5in;
            position: relative;
            background-image: url('../assets/images/${bgFile}');
    ...
    .character-lighting::before {
        ...
        pointer-events: none;
        z-index: 1;
        ${poseFile ? `/* Layer gradient over character image */
        background-image:
            linear-gradient(to bottom, rgba(255, 107, 53, 0.5) 0%, rgba(78, 205, 196, 0.5) 100%),
            url('../assets/poses/new-story/${poseFile}');
        background-size: 100% 100%, contain;
        background-position: center, center;
        background-repeat: no-repeat, no-repeat;
        background-blend-mode: overlay;
        /* Mask the entire thing to only show where character has pixels */
        -webkit-mask-image: url('../assets/poses/new-story/${poseFile}');
        -webkit-mask-size: contain;
        -webkit-mask-repeat: no-repeat;
        -webkit-mask-position: center;
        mask-image: url('../assets/poses/new-story/${poseFile}');
        mask-size: contain;
    ...
    <div class="page">
        ...
        ${poseFile ? `
          <div class="character character-lighting" id="character">
              <img src="../assets/poses/new-story/${poseFile}" alt="Character">
          </div>` : '<!-- No character image for this page -->'}
    </div>
...
Object.entries(pageData).forEach(([pageNum, [title, bgFile, poseFile, text]]) => {
  const fileName = `page${String(pageNum).padStart(2, '0')}-test.html`;
  const filePath = path.join(testPagesDir, fileName);
  const html = template(pageNum, title, bgFile, poseFile, text);
  
  fs.writeFileSync(filePath, html, 'utf8');
  console.log(`✅ Created ${fileName}`);
});

console.log('\n🎉 All 14 test pages generated successfully!');
console.log('\n📝 Note: Page 12 uses placeholder background (TBD)');
console.log('📝 Pages 12-13 use placeholder poses until you create final ones');
